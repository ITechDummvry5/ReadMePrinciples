...
| ----------- | -------------------------------------------------------------------- | ------- | ---------------------------------- |
| Projects    | [`project-proj/`](https://github.com/ITechDummvry5/project-proj)     | `proj-` | Main development projects          |
| Clones      | [`clone-cln/`](https://github.com/ITechDummvry5/clone-cln)           | `cln-`  | Recreations of existing projects   |
| Learning    | [`learn-lrn/`](https://github.com/ITechDummvry5/learn-lrn)           | `lrn-`  | Learning and practice projects     |
| Experiments | [`experiment-exp/`](https://github.com/ITechDummvry5/experiment-exp) | `exp-`  | Tests, prototypes, and ideas       |
| Tools       | [`tools-tool/`](https://github.com/ITechDummvry5/tools-tool)         | `tool-` | Utilities and developer tools      |
| Templates   | [`template-tpl/`](https://github.com/ITechDummvry5/template-tpl)     | `tpl-`  | Reusable starters and boilerplates |
